...
WebContents.prototype._init = function () {
  ...
  if (this.getType() !== 'remote') {
    ...
    if (prefs.nodeIntegration != null && !prefs.nodeIntegration) {
      electron.deprecate.log('Deprecation Warning: Disabling nodeIntegration is deprecated. In Electron 12, all non-sandboxed renderers will have node integration enabled. To separate node from page content, use contextIsolation. See https://github.com/electron/electron/issues/23506 for more details.');
    }
  }
